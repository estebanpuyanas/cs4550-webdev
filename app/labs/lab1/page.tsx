  ...
  return (
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        Meal Prep Chicken and Rice (cooks for ~2x meals for 7 days):
        <ol id="esteban-favorite-recipe">
          <li>
            Measure two cups of dry jasmine rice and wash them in lukewarm water
            throughly.
          </li>
          <li>
            Add the washed rice, 1 chopped white onion, and 3 crhushed garlic
            cloves into a pot with olive oil.
          </li>
          <li>
            Add 2 cups of water/broth for every cup of rice, turn up to high
            heat, and cover once bubbly.
          </li>
          <li>
            While the rice is cooking, get 10 lbs of chicken thighs, season to
            taste and lay in a baking sheet.
          </li>
          <li>
            Cook in oven at 375 F for 1 hour or until internal temperature
            reaches 165 F.
          </li>
        </ol>
      ...
      Please
      <a
        href="https://www.github.com/estebanpuyanas/cs4550-webdev"
        id="wd-github"
      >
        click here
      </a>
      to view the source code for this web application.
      <br />
    </div>
  );
}
